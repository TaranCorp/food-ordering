...
public class OrderApprovalEventPayload {
    ...
    public OrderApprovalEventPayload(String orderId, String restaurantId, BigDecimal price, ZonedDateTime createdAt, String restaurantOrderStatus, List<OrderApprovalEventProduct> products) {
