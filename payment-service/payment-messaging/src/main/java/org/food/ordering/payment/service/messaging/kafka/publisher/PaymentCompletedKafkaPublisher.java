...
public class PaymentCompletedKafkaPublisher implements PaymentCompletedMessagePublisher {
    ...
    public PaymentCompletedKafkaPublisher(KafkaProducer<String, PaymentResponseAvroModel> kafkaProducer,
    ...
    public void publish(PaymentCompletedEvent domainEvent) {
        ...
        final PaymentResponseAvroModel paymentResponseAvroModel = paymentMessagingMapper.paymentResponseAvroModelFromPaymentCompletedEvent(domainEvent);
